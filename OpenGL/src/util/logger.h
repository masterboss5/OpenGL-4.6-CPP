...
#define LOG_INFO(message)                                                                                                                  \
	std::cerr << ANSI_WHITE << ANSI_UNDERLINE << "[INFO]"                                                                                  \
			  << "[" << __FILE__ << ": " << __func__ << ": " << __LINE__ << "] " << message << ANSI_RESET << std::endl;

#define LOG_WARN(message)                                                                                                                  \
	std::cerr << ANSI_YELLOW << ANSI_UNDERLINE << "[WARN]"                                                                                 \
			  << "[" << __FILE__ << ": " << __func__ << ": " << __LINE__ << "] " << message << ANSI_RESET << std::endl;

#define LOG_ERROR(message)                                                                                                                 \
	std::cerr << ANSI_RED << ANSI_UNDERLINE << "[ERROR]"                                                                                   \
			  << "[" << __FILE__ << ": " << __func__ << ": " << __LINE__ << "] " << message << ANSI_RESET << std::endl;
#else
#define LOG_INFO(message)
#define LOG_WARN(message)
