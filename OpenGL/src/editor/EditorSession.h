...
#include "src/editor/asset/AssetImportService.h"
...
#include "src/editor/build/ProjectBuildService.h"
...
#include "src/editor/preferences/EditorPreferences.h"
#include "src/editor/project/Project.h"
#include "src/editor/recovery/EditorRecoveryStore.h"
...
class EditorSession final
{
  public:
	...
	[[nodiscard]] bool PollProjectBuild(core::threading::TaskScheduler &Scheduler);
