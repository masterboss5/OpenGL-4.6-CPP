										 ...
										 const HybridDeferredPassCallbacks &Callbacks, HybridDeferredFrameResources &Resources) const
{
	...
	const Extent2D DirectionalShadowExtent{pipeline::render::DirectionalShadowResolution, pipeline::render::DirectionalShadowResolution};
	...
	Resources = HybridDeferredFrameResources{
		...
		.SpotShadowAtlas = Graph.CreateTexture("SpotShadowAtlas", SpotShadowExtent, TextureFormat::Depth32Float,
											   TextureDimension::Texture2DArray, 1, SpotShadowLayers, 1, true),
		.PointShadowArray = Graph.CreateTexture("PointShadowArray", PointShadowExtent, TextureFormat::Depth32Float,
												TextureDimension::TextureCubeArray, 1, PointShadowFaceLayers, 1, true),
