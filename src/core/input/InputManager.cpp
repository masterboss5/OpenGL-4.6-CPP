...
void core::input::InputManager::lockMouse() const
{
    glfwSetInputMode(Window::windowPtr->window, GLFW_CURSOR, GLFW_CURSOR_DISABLED);
}

void core::input::InputManager::unlockMouse() const
{
    glfwSetInputMode(Window::windowPtr->window, GLFW_CURSOR, GLFW_CURSOR_NORMAL);
}
