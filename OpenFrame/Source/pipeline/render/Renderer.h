...
#include "Source/pipeline/frame/FrameResourceRing.h"
#include "Source/pipeline/graph/HybridDeferredFrameGraph.h"
#include "Source/pipeline/mesh/MeshGpuResource.h"
#include "Source/pipeline/render/RenderPassPipelineSet.h"
...
class ENGINE_API Renderer final
{
  ...
  private:
	...
	uint32 HeadlessEligibleFrameCount = 0;
	std::filesystem::path HeadlessPresentationCapturePath;
	...
	struct ViewState final
	{
		...
		bool PreviousTemporalJitterEnabled = true;
		...
		pipeline::render::RenderLODHistory PreviousLODSelections;
		pipeline::render::RenderLODHistory CurrentLODSelections;
