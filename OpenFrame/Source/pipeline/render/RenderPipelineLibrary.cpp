...
{
	static constexpr std::array<string_view, 30> ShaderPaths{"Shaders/ShadowDepth.vert",
															 "Shaders/ShadowDepth.frag",
															 "Shaders/GBuffer.vert",
															 "Shaders/DepthMasked.frag",
															 "Shaders/GBuffer.frag",
															 "Shaders/TransparentOIT.frag",
															 "Shaders/AccuratePicking.frag",
															 "Shaders/EditorWireframe.frag",
															 "Shaders/EditorGrid.vert",
															 "Shaders/EditorGrid.frag",
															 "Shaders/GizmoOverlay.vert",
															 "Shaders/GizmoOverlay.frag",
															 "Shaders/EditorDebugLine.vert",
															 "Shaders/EditorDebugLine.frag",
															 "Shaders/Fullscreen.vert",
															 "Shaders/ToneMap.frag",
															 "Shaders/Visibility.comp",
															 "Shaders/VisibilityPrefixScan.comp",
															 "Shaders/VisibilityBlockPrefixScan.comp",
															 "Shaders/VisibilityFinalize.comp",
															 "Shaders/VisibilityScatter.comp",
															 "Shaders/HiZ.comp",
															 "Shaders/ClusteredLights.comp",
															 "Shaders/DeferredLighting.comp",
															 "Shaders/OITComposite.comp",
															 "Shaders/TAA.comp",
															 "Shaders/ViewportVisualization.comp",
															 "Shaders/SelectionOutline.comp",
															 "Shaders/AutoExposure.comp",
															 "Shaders/Bloom.comp"};
	Scheduler
		.Submit(
			[&Assets]()
	...
	: Shaders(Device, Assets)
{
	this->ShadowDepthPipeline = this->Shaders.CreateGraphicsPipeline(
		{.Vertex = {.Path = "Shaders/ShadowDepth.vert", .Stage = pipeline::shader::ShaderStage::Vertex},
		 .Fragment = {.Path = "Shaders/ShadowDepth.frag", .Stage = pipeline::shader::ShaderStage::Fragment},
	...
	this->DepthPrepassPipeline = this->Shaders.CreateGraphicsPipeline(
		{.Vertex = {.Path = "Shaders/GBuffer.vert", .Stage = pipeline::shader::ShaderStage::Vertex},
		 .Fragment = {.Path = "Shaders/DepthMasked.frag", .Stage = pipeline::shader::ShaderStage::Fragment},
	...
	this->GBufferPipeline = this->Shaders.CreateGraphicsPipeline(
		{.Vertex = {.Path = "Shaders/GBuffer.vert", .Stage = pipeline::shader::ShaderStage::Vertex},
		 .Fragment = {.Path = "Shaders/GBuffer.frag", .Stage = pipeline::shader::ShaderStage::Fragment},
	...
	this->TransparentOITPipeline = this->Shaders.CreateGraphicsPipeline(
		{.Vertex = {.Path = "Shaders/GBuffer.vert", .Stage = pipeline::shader::ShaderStage::Vertex},
		 .Fragment = {.Path = "Shaders/TransparentOIT.frag", .Stage = pipeline::shader::ShaderStage::Fragment},
	...
	this->AccuratePickingPipeline = this->Shaders.CreateGraphicsPipeline(
		{.Vertex = {.Path = "Shaders/GBuffer.vert", .Stage = pipeline::shader::ShaderStage::Vertex},
		 .Fragment = {.Path = "Shaders/AccuratePicking.frag", .Stage = pipeline::shader::ShaderStage::Fragment},
		 .State = {.DepthStencil = {.DepthTest = true, .DepthWrite = true, .DepthCompare = pipeline::shader::CompareFunction::Greater},
				   .RenderTargets =
	...
	this->EditorWireframePipeline = this->Shaders.CreateGraphicsPipeline(
		{.Vertex = {.Path = "Shaders/GBuffer.vert", .Stage = pipeline::shader::ShaderStage::Vertex},
		 .Fragment = {.Path = "Shaders/EditorWireframe.frag", .Stage = pipeline::shader::ShaderStage::Fragment},
	...
	this->EditorGridPipeline = this->Shaders.CreateGraphicsPipeline(
		{.Vertex = {.Path = "Shaders/EditorGrid.vert", .Stage = pipeline::shader::ShaderStage::Vertex},
		 .Fragment = {.Path = "Shaders/EditorGrid.frag", .Stage = pipeline::shader::ShaderStage::Fragment},
	...
	this->GizmoOverlayPipeline = this->Shaders.CreateGraphicsPipeline(
		{.Vertex = {.Path = "Shaders/GizmoOverlay.vert", .Stage = pipeline::shader::ShaderStage::Vertex},
		 .Fragment = {.Path = "Shaders/GizmoOverlay.frag", .Stage = pipeline::shader::ShaderStage::Fragment},
		 .State = {.Rasterizer = {.CullMode = pipeline::shader::CullMode::None},
	...
	this->EditorDebugLinePipeline = this->Shaders.CreateGraphicsPipeline(
		{.Vertex = {.Path = "Shaders/EditorDebugLine.vert", .Stage = pipeline::shader::ShaderStage::Vertex},
		 .Fragment = {.Path = "Shaders/EditorDebugLine.frag", .Stage = pipeline::shader::ShaderStage::Fragment},
		 .State = {.Rasterizer = {.CullMode = pipeline::shader::CullMode::None},
				   .DepthStencil = {.DepthTest = true,
									.DepthWrite = false,
									.DepthCompare = pipeline::shader::CompareFunction::GreaterEqual},
	...
	this->ToneMapPipeline = this->Shaders.CreateGraphicsPipeline(
		{.Vertex = {.Path = "Shaders/Fullscreen.vert", .Stage = pipeline::shader::ShaderStage::Vertex},
		 .Fragment = {.Path = "Shaders/ToneMap.frag", .Stage = pipeline::shader::ShaderStage::Fragment},
	...
	this->HierarchicalDepthPipeline = this->Shaders.CreateComputePipeline(
		{.Compute = {.Path = "Shaders/HiZ.comp", .Stage = pipeline::shader::ShaderStage::Compute},
	...
	this->ClusteredLightsPipeline = this->Shaders.CreateComputePipeline(
		{.Compute = {.Path = "Shaders/ClusteredLights.comp", .Stage = pipeline::shader::ShaderStage::Compute},
	...
	this->DeferredLightingPipeline = this->Shaders.CreateComputePipeline(
		{.Compute = {.Path = "Shaders/DeferredLighting.comp", .Stage = pipeline::shader::ShaderStage::Compute},
		 .RequiredUniforms = pipeline::shader::UniformBit(pipeline::shader::ComputeUniform::LightCount) |
							 pipeline::shader::UniformBit(pipeline::shader::ComputeUniform::ClusterCount),
		 .RequiredEngineInterface = UniformInterface(RendererBinding::FrameConstants) | StorageInterface(RendererBinding::Lights) |
									StorageInterface(RendererBinding::ClusterHeaders) | StorageInterface(RendererBinding::ClusterIndices) |
	...
	this->OITCompositionPipeline = this->Shaders.CreateComputePipeline(
		{.Compute = {.Path = "Shaders/OITComposite.comp", .Stage = pipeline::shader::ShaderStage::Compute},
		 .RequiredResources = {
	...
	this->ViewportVisualizationPipeline = this->Shaders.CreateComputePipeline(
		{.Compute = {.Path = "Shaders/ViewportVisualization.comp", .Stage = pipeline::shader::ShaderStage::Compute},
	...
	this->SelectionOutlinePipeline = this->Shaders.CreateComputePipeline(
		{.Compute = {.Path = "Shaders/SelectionOutline.comp", .Stage = pipeline::shader::ShaderStage::Compute},
	...
	this->AutoExposurePipeline = this->Shaders.CreateComputePipeline(
		{.Compute = {.Path = "Shaders/AutoExposure.comp", .Stage = pipeline::shader::ShaderStage::Compute},
		 .RequiredUniforms = pipeline::shader::UniformBit(pipeline::shader::ComputeUniform::HistoryValid) |
	...
	this->BloomPipeline = this->Shaders.CreateComputePipeline(
		{.Compute = {.Path = "Shaders/Bloom.comp", .Stage = pipeline::shader::ShaderStage::Compute},
