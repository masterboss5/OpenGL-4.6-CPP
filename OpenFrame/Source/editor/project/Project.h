...
#include "Source/runtime/project/VirtualFileSystem.h"
...
struct ProjectPaths final
{
	...
	[[nodiscard]] static ProjectPaths FromDescriptor(const std::filesystem::path &DescriptorPath, const util::UUID &ProjectID);
